        ...
        <main className='text-center mx-auto pt-3'>
            ...
            <div className='d-flex justify-content-around mx-auto my-3'>
                <div className='col-5 col-md-3 mx-2'>
                    ...
                    <input type='text' id='firstName' className='form-control' maxLength="30" autoComplete="off" required />
                ...
                <div className='col-5 col-md-3 mx-2'>
                    ...
                    <input type='text' id='secondName' className='form-control' maxLength="30" autoComplete="off" required />
